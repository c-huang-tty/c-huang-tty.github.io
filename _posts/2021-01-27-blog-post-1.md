...
<img src="https://render.githubusercontent.com/render/math?math=\text{RegSS} = {\displaystyle \sum_{i=1}^n(\hat{y}_i-\bar{y})^2 = b_1^2L_{XX}} \Rightarrow \dfrac{\text{RegSS}}{\sigma^2}\sim \chi^2(1)">

As <img src="https://render.githubusercontent.com/render/math?math=\dfrac{\text{RSS}}{\sigma^2}\sim \chi^2(n-2)">, therefore,

<img src="https://render.githubusercontent.com/render/math?math=F = \dfrac{\text{RegSS}}{\text{RSS}/(n-2)} = F(1,n-2)">
