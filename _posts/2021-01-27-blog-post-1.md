...
<img src="https://render.githubusercontent.com/render/math?math=\text{ResSS} = {\displaystyle \sum_{i=1}^n(\hat{y}_i-\bar{y})^2 = b_1^2L_{XX}} \Rightarrow \dfrac{\text{RSS}}{\sigma^2}\sim \chi^2(1)">
