...
<img src="https://render.githubusercontent.com/render/math?math=var(b_0) = var\left(\bar{\varepsilon - b_1\bar{x}}\right) = \dfrac{var(\varepsilon)}{n}%2B \bar{x}^2var(b_0) = \sigma^2\left(\dfrac{1}{n}%2B \dfrac{\bar{x}^2}{L_{XX}}\right)">
