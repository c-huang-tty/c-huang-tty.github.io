...
<img src="https://render.githubusercontent.com/render/math?math=P(x=i) = \dfrac{\dbinom{n}{i}\dbinom{m}{N-i}}{\dbinom{m+n}{N}}">
...
<img src="https://render.githubusercontent.com/render/math?math=P(X_1=x_1, ..., X_n=x_n) = \dfrac{N!}{\prod_{i=1}^{n}x_i}\displaystyle\prod_{i=1}^n\theta_i^{x_i}">
