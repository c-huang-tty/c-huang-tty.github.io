...
This post will summarize some of the commonly used discrete distributions, including uniform distribution, Bernoulli distribution, binomial distribution, geometric distribution, negative binomial distribution, Poisson distribution, hypergeometric distribution and mulitnomial distribution.
