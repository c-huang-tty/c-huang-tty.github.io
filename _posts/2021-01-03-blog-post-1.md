...
This post will summarize some of the commonly used discrete distributions, including Bernoulli distribution, binomial distribution, geometric distribution, negative binomial distribution, uniform distribution, Poisson distribution, hypergeometric distribution and mulitnomial distribution.
