...
__Test 1__: Let 
<img src="https://render.githubusercontent.com/render/math?math=m_{%2B}">
be the total account of categories 
<img src="https://render.githubusercontent.com/render/math?math=0-99">, then 
<img src="https://render.githubusercontent.com/render/math?math=m_{%2B} = 118"> 
for Taylor poem. Similarly, let 
<img src="https://render.githubusercontent.com/render/math?math=\mu_{%2B} = \sum\mu_x">, so that <img src="https://render.githubusercontent.com/render/math?math=m_{%2B}"> has a Poisson distribution of mean 
<img src="https://render.githubusercontent.com/render/math?math=\mu_{%2B}">. Test 1 is just the usual test of the simple null hypothesis 
